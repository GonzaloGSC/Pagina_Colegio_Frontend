...
class Nivel extends Component {
    ...
    componentDidMount(){
        ...
        fetch('https://escuelasespeciales.cl/curso/list?id_colegio=3&ordering=nombre&tipo=basico')
        ...
        <>
                ...
                <div className="NivelWrapper">
                    <div className="NivelColumn">
                        <div className="NivelRow">
                            <div id="NivelTituloM" className="NivelTitulo">Niveles Básicos (7 a 14 años +2)</div>
                            <div className="NivelRow2">
                                <div id="NivelTextoM" className="NivelTexto">Los niveles basicos que se cursan en este establecimiento son los siguientes:
                                <br/>
                                    {OC.map(item => <div className="NivelTexto" id='NivelTextoFila'>• {item.nombre}</div>)}
                                </div>
                                <div id="NivelTextoM" className="NivelTexto">
            ...
            <div className="NivelContainer">
                <div className="NivelWrapper">
                    <div className="NivelColumn">
                        <div className="NivelRow">
                            <div id="NivelTituloM" className="NivelTitulo">Niveles Laborales (15 a 24 años +2)</div>
                            <div className="NivelRow2">
                                <div id="NivelTextoM" className="NivelTexto">Los niveles laborales que se cursan en este establecimiento son los siguientes:
                                <br/>
