...
export default function ContactUs() {
  ...
  function sendEmail(e) {
    ...
    emailjs.sendForm('gmail', 'Admision_Monte', e.target, `${credentials.correomonte}`)
      .then((result) => {
    ...
    useEffect(()=>{
        fetch('https://escuelasespeciales.cl/curso/list?ordering=nombre&id_colegio=3')
    ...
    <div className="AdmisionFormContainer">
        <form id="AdmisionWidth" onSubmit={sendEmail} className="form">
            ...
            <span className='AdmisionForm-input-login'>
                O contactanos directamente llamando al:<p>(+569) 62382639 o (2) 2534 8490</p>
            </span>
        </form>
    </div>
    );
