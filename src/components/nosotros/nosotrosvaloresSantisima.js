...
import Imagen from '../../imagenes/Sellos/Sello_Santisima.png'
import './nosotros.css'
                ...
                <div className="NosotrosRow">
                    ...
                    <div className="faq">
                        <Faq 
                            coloricono="red"
                            colorb="faqS"
                            color="faqcolorS" title= "Responsabilidad" 
                    ...
                    <div className="faq">
                        <Faq 
                            coloricono="red"
                            colorb="faqS"
                            color="faqcolorS" title= "Honestidad" 
                    ...
                    <div className="faq">
                        <Faq 
                            coloricono="red"
                            colorb="faqS"
                            color="faqcolorS" title= "Superación" 
                    ...
                    <div className="faq">
                        <Faq 
                            coloricono="red"
                            colorb="faqS"
                            color="faqcolorS" title= "Solidaridad" 
