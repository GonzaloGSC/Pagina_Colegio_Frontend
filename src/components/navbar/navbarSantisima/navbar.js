...
function Navbar(){
  ...
  return(
    <nav className="NavbarContainer" id="NavbarContainerS">
        <nav className="NavbarItems">
          <div className="menu-icon" onClick={()=>{handleClick(); closeDropdown1(); closeDropdown2(); closeDropdown3()}}>
            <i className={click?"fas fa-times":"fas fa-bars"}/>
          </div>
          <ul id="NavbarContainerS" className={click?"nav-menu active":"nav-menu"}>
            <li  className="nav-item">
              <Link id="NavLinkS" to="/santisima_trinidad" className="nav-links" onClick= {closeMovileMenu}>
                INICIO
              </Link>
            </li>
            ...
            >
              <div id="NavLinkS" className="nav-links-dropdown" onClick= {()=>{handleClickDropdown1(); closeDropdown2(); closeDropdown3()}}>
            ...
            >
              <div id='NavLinkS' className="nav-links-dropdown" onClick= {()=>{handleClickDropdown2(); closeDropdown1(); closeDropdown3()}}>
            ...
            >
              <div id='NavLinkS' className="nav-links-dropdown" onClick= {()=>{handleClickDropdown3(); closeDropdown1(); closeDropdown2()}}>
                COLEGIO SEGURO <i className="fas fa-caret-down" />
              </div>
              {clickDropdown3 || seguro3? <Dropdown3/> : ""}
            </li>
            {/* <li  className="nav-item">
              <Link id="NavLinkS" to="/santisima_trinidad/colegio_seguro" className="nav-links" onClick= {closeMovileMenu}>
                COLEGIO SEGURO COVID-19
              </Link>
            </li> */}
            <li  className="nav-item">
              <Link id="NavLinkS" to="/santisima_trinidad/admision" className="nav-links" onClick= {closeMovileMenu}>
                ADMISIÓN
              </Link>
            </li>
            <li className="nav-item">
              <Link  id="NavLinkS" to="/santisima_trinidad/preguntas_frecuentes" className="nav-links" onClick= {closeMovileMenu}>
                PREGUNTAS FRECUENTES
              </Link>
            </li>
            <li className="nav-item">
              <Link id="NavLinkS" to="/santisima_trinidad/contacto" className="nav-links" onClick= {closeMovileMenu}>
                CONTACTO
              </Link>
            </li>
