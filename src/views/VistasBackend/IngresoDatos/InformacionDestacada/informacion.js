...
class Informacion extends Component {
    ...
    handleSubmit = (event) => {
        ...
        fetch('https://escuelasespeciales.cl/info_destacada/create',{
            method: 'POST',
            headers: {
        ...
        .then(async response => { 
            ...
            if(!response.ok){
                ...
                alert("Error al intentar ingresar la Actividad, la sesion expiro, vuelva a iniciar sesion nuevamente")
                return Promise.reject(error);
            }
            alert("Actividad agregada satisfactoriamente ")
            this.setState({
                titulo: '',
                descripcion:'',
                archivo: null,
    ...
    return (
        ...
        <div className="AdmisionContainer">
            ...
            <div className="AdmisionWrapper">
                <h1 id="TituloDatos">Ingreso Actividad </h1>
                <div id="IngresoDatos" className="AdmisionFormContainer">
                    <form id="AdmisionWidth" className="form" onSubmit={this.handleSubmit} >
                        ...
                        <div className='AdmisionForm-inputs'>
                            <label className="AdmisionForm-label">Nombre de la Actividad*</label>
