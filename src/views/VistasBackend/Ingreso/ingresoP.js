    ...
    render(){
            ...
            return (
                ...
                <div className="AdmisionContainer">
                    ...
                    <h1 id="TituloDatos2">Ingreso de Guías de {Col}</h1>
                <div id="IngresoDatos" className="AdmisionFormContainer">
                <form id="AdmisionWidth" className="form">
                    <h1>Presiona para agregar una nueva guía</h1>
                    <Button type ="button" href="/datos/ingreso/guias" id="IngresoBoton"><Icon className="fas fa-plus"/>Agregar Guias</Button>
                </form>
            </div>
