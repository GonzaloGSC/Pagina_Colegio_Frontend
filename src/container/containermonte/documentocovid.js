...
import Imagen from '../../imagenes/banner_documentos_covid_monte.png'
...
class DocumentosCovid extends Component{
    ...
    componentDidMount(){
        fetch('https://escuelasespeciales.cl/documento_oficial/list?ordering=-id&id_colegio=3&id_identificador=1')
            ...
            return (
                <div>
                 <Banner src={Imagen} text="Documentos Covid-19"/> 
                    <Titulo id="TituloM"  icono="fas fa-file-alt" titulo="Descarga de Documentos Covid-19" Subtitulo2="A continuación se presentan documentos relacionados con protocolos Covid-19, los cuales se encuentran disponibles para su descarga directa.-" />
            ...
            return (
                <div>
                 <Banner src={Imagen} text="Documentos Covid-19"/> 
                    ...
                    <div className="DocumentosContainer">
                        <div className="DocumentosWrapper">
                            <h2 id="SubtituloM1">No hay documentos aún</h2>
                        </div>
                    </div>
                </div>
            )
