...
class documentos extends Component{
    ...
    componentDidMount(){
        fetch('https://escuelasespeciales.cl/seguro_escolar/list?ordering=-id&id_colegio=3')
    ...
    render(){
        return (
            <div>
                ...
                <Titulo id="TituloM" icono="fas fa-file-alt" titulo="Descarga de Seguro Escolar" Subtitulo2="A continuación se presentan el/los seguros escolares para el presente año.-" />
