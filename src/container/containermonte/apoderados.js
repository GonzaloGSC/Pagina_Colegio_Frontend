...
function apoderados() {
    return (
        <div>
            ...
            <Titulo id="TituloM" titulo="Información importante" icono="fas fa-info-circle" Subtitulo2="A continuación se presenta información importante sobre uniforme y transporte escolar"/>
            <Apoderados   
                color="SubtituloM"  
