...
import Imagen from '../../imagenes/banner_infraestructura_monte.png';
...
class Infraestructura extends React.Component {
    ...
    componentDidMount(){
        fetch('https://escuelasespeciales.cl/infraestructura/list?id_colegio=3&id_identificador=0')
    ...
    render(){
        if(this.state.arreglo.length !==0){
            return (
                ...
                <Banner src={Imagen} text="Nuestro Colegio"/>
                    <Titulo 
                        ...
                        Subtitulo2="Nuestro colegio esta ubicado en Av. Portales 285 en 
                                    la comuna de Maipú. El espacio que ocupamos ha sido mejorado
            ...
            return (
                ...
                <div className="ProfesionalContainer">
                    <div className="ProfesionalWrapper">
                        <h2 id="SubtituloM">No hay Infraestructuras aún</h2>
                    </div>
                </div>
                </div>
            )
