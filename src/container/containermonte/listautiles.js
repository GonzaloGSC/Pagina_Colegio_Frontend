...
import Imagen from '../../imagenes/banner_nivel_monte.png';
...
class Listautiles extends Component{
    ...
    componentDidMount(){
        fetch('https://escuelasespeciales.cl/documento_oficial/list?ordering=-id&id_colegio=3&id_identificador=2')
            ...
            return (
                <div>
                 <Banner src={Imagen} text="Lista de Útiles"/> 
                    <Titulo id="TituloM"  icono="fas fa-file-alt" titulo="Descarga de lista de útiles" Subtitulo2="A continuación se presenta un listado de útiles escolares necesarios para nuestros alumnos, los cuales se encuentran disponibles para su descarga directa.-" />
            ...
            return (
                <div>
                 <Banner src={Imagen} text="Lista de Útiles"/> 
                    ...
                    <div className="DocumentosContainer">
                        <div className="DocumentosWrapper">
                            <h2 id="SubtituloM1">No hay lista de útiles aún</h2>
                        </div>
                    </div>
                </div>
            )
