...
import Imagen from '../../imagenes/banner_infraestructura_covid_monte.png';
...
class Covid extends React.Component {
    ...
    componentDidMount(){
        fetch('https://escuelasespeciales.cl/infraestructura/list?id_colegio=3&id_identificador=1')
    ...
    render(){
        ...
        if(this.state.arreglo.length !== 0){
            ...
            return (
                ...
                <div className="ProfesionalContainer">
                    <div className="ProfesionalWrapper">
                        <h2 id="SubtituloM1">No hay Infraestructras aún</h2>
                    </div>
                </div>
                </div>
            )
