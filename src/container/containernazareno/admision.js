...
import Admision from '../../components/admision/admisionNazareno';
import AdmisionForm from '../../components/admision/admisionformnazareno';
import Imagen from '../../imagenes/banner_admision_nazareno.png';
...
function Admisionform() {
    ...
    return (
        <div>
            ...
            <Titulo  id="TituloN" icono="fas fa-user-plus" titulo={titulo} Subtitulo2="A continuación se presenta un listado de la documentación requerida para realizar una postulación a nuestra institución, asi como la infomación de los periodos de dicho proceso.-" />
            <Admision 
                    color="SubtituloN"
