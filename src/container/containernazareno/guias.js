...
import Imagen from '../../imagenes/banner_guia_nazareno.png';
...
class guias extends Component{
    ...
    handleSubmit = (event) => {
        ...
        let url="https://escuelasespeciales.cl/guia_pedagogica/list?curso__nombre="+curso.replace(/ /g, "+")+"&jornada__nombre="+jornada.replace(/ /g, "+")+"&profesor__nombre="+profesor.replace(/ /g, "+")+"&ramo__nombre="+asignatura.replace(/ /g, "+")+'&ordering=titulo&id_colegio=2';
    ...
    componentDidMount(){
        ...
        fetch('https://escuelasespeciales.cl/curso/list?id_colegio=2&ordering=nombre')
            .then(response => response.json())
            .then(data => this.setState({OC:data}));

        fetch('https://escuelasespeciales.cl/jornada/list?id_colegio=2&ordering=nombre')
            .then(response => response.json())
            .then(data => this.setState({OJ:data}));

        fetch('https://escuelasespeciales.cl/profesor_guias/list?id_colegio=2&ordering=nombre')
            .then(response => response.json())
            .then(data => this.setState({OP:data}));

        fetch('https://escuelasespeciales.cl/asignatura/list?&id_colegio=2&ordering=nombre')
            .then(response => response.json())
        ...
        if(this.state.arreglo.length !== 0){
            ...
            return (
                <div>
                    ...
                    <div className="DocumentosContainer">
                        <div className="DocumentosWrapper">
                            <h2 id="SubtituloN">No hay guías ni documentos aún</h2>
                        </div>
                    </div>
