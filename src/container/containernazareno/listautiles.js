...
class Listautiles extends Component{
    ...
    componentDidMount(){
        fetch('https://escuelasespeciales.cl/documento_oficial/list?ordering=-id&id_colegio=2&id_identificador=2')
    ...
    render(){
        ...
        if(arreglo.length !== 0){
            return (
                <div>
                 <Banner src={Imagen} text="Lista de Útiles"/> 
                    <Titulo id="TituloN"  icono="fas fa-file-alt" titulo="Descarga de lista de útiles" Subtitulo2="A continuación se presenta un listado de útiles escolares necesarios para nuestros alumnos, los cuales se encuentran disponibles para su descarga directa.-" />
            ...
            return (
                <div>
                 <Banner src={Imagen} text="Lista de Útiles"/> 
                    <Titulo id="TituloN"  icono="fas fa-file-alt" titulo="Descarga de lista de útiles" 
                    Subtitulo2="A continuación se presenta un listado de útiles escolares necesarios para nuestros alumnos, los cuales se encuentran disponibles para su descarga directa.-" />
                    <div className="DocumentosContainer">
                        <div className="DocumentosWrapper">
                            <h2 id="SubtituloN">No hay lista de útiles aún</h2>
                        </div>
                    </div>
                </div>
            )
