...
import Imagen from '../../imagenes/banner_infraestructura_santisima.png';
...
class Infraestructura extends React.Component {
    ...
    componentDidMount(){
        fetch('https://escuelasespeciales.cl/infraestructura/list?id_colegio=1&id_identificador=0')
    ...
    render(){
        ...
        if(this.state.arreglo.length !== 0){
            return (
                ...
                <Banner src={Imagen} text="Nuestro Colegio"/>
                    <Titulo  id="TituloS" 
                        ...
                        Subtitulo2="Nuestro colegio esta ubicado en Federico Errázuriz 793 en 
            ...
            return (
                ...
                <div className="ProfesionalContainer">
                    <div className="ProfesionalWrapper">
                        <h2 id="SubtituloS1">No hay Infraestructuras aún</h2>
                    </div>
                </div>
                </div>
            )
