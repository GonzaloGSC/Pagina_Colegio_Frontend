...
class Horario extends Component{
    ...
    componentDidMount(){
        fetch('https://escuelasespeciales.cl/documento_oficial/list?ordering=-id&id_colegio=1&id_identificador=3')
            ...
            return (
                <div>
                 <Banner src={Imagen} text="Horario Escolar"/> 
                    <Titulo id="TituloS"  icono="fas fa-file-alt" titulo="Descarga de Horario" Subtitulo2="A continuación se presenta un listado de horarios de clases para nuestros alumnos, los cuales se encuentran disponibles para su descarga directa.-" />
            ...
            return (
                <div>
                 <Banner src={Imagen} text="Horario Escolar"/> 
                    ...
                    <div className="DocumentosContainer">
                        <div className="DocumentosWrapper">
                            <h2 id="SubtituloS1">No hay Horarios aún</h2>
                        </div>
                    </div>
                </div>
            )
