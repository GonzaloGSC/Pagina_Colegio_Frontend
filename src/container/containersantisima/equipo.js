...
import Imagen from '../../imagenes/banner_equipo_santisima.png';
...
class Equipo extends React.Component {
    ...
    componentDidMount(){
        fetch('https://escuelasespeciales.cl/profesional_portada/list?id_colegio=1')
        ...
        if(this.state.arreglo.length !==0){
            return (
                <div>
                    ...
                    <Titulo  id="TituloS" icono="far fa-address-book" titulo="Nuestros profesionales" Subtitulo2="A continuación se presenta el rol, área y trabajo que realiza cada uno de nuestros profesionales dentro de nuestra institución.-"/>
            ...
            return (
                ...
                <div className="ProfesionalContainer">
                    <div className="ProfesionalWrapper">
                        <h2 id="SubtituloS1">No hay Profesionales aún</h2>
                    </div>
                </div>
                </div>
            )
