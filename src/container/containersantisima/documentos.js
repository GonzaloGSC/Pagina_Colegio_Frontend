...
import Imagen from '../../imagenes/banner_documentos_santisima.png'
...
class documentos extends Component{
    ...
    componentDidMount(){
        fetch('https://escuelasespeciales.cl/documento_oficial/list?ordering=-id&id_colegio=1&id_identificador=0')
            ...
            return (
                <div>
                 <Banner src={Imagen} text="Documentos"/> 
                    <Titulo id="TituloS"  icono="fas fa-file-alt" titulo="Descarga de documentos" Subtitulo2="A continuación se presenta un listado de la documentación oficial de nuestra intitución, los cuales se encuentran disponibles para su descarga directa.-" />
