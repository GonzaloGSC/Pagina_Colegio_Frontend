...
import Imagen from '../../imagenes/banner_faq_santisima.png';
...
export default class MenuFaq extends Component{
  ...
  componentDidMount(){
      ...
      fetch('https://escuelasespeciales.cl/cargo/list?id_colegio=1&ordering=nombre')
          .then(response => response.json())
      ...
      return (
        ...
        <div className="FaqContainer">
          <div className="FaqWrapper">
            ...
            <div>
              <Titulo id="TituloS" icono="fas fa-question-circle" titulo="Preguntas mas frecuentes"/>
              <div className="h2TS"><IconSubtitle className="fas fa-graduation-cap"/>Sobre el colegio</div>
                <div className="faq">
                  <Faq
                  coloricono="red"
                  colorb="faqS"
              ...
              <div className="h2TS"><IconSubtitle className="fas fa-chalkboard-teacher"/>Sobre las clases</div>
                <div className="faq">
                    <Faq
                    coloricono="red"
                    colorb="faqS"
                    ...
                    content ="Santísima Trinidad cuenta con los niveles de:
                    ...
                    content = {`Los Talleres laborales impartidos por Santísima Trinidad son:  <p></p> ${Talleres}`}
                    />
                    <Faq
                    coloricono="red"
                    colorb="faqS"
                    ...
                    content ="<p></p> • En Enseñanza General Básica
                              hasta que terminen Octavo Básico (14 a 16 años) <p></p> • En Nivel Laboral
                              hasta los 24 años extendiendo a 26 los alumnos antiguos
                              "
                    />
                  </div>
              <div className="h2TS"><IconSubtitle className="fas fa-briefcase"/>Otras</div>
                <div className="faq">
                    <Faq
                    coloricono="red"
                    colorb="faqS"
                    ...
                    content ={`Santísima Trinidad cuenta con: <p></p> ${Cargo}`}
                    />
                    <Faq
                    coloricono="red"
                    colorb="faqS"
                    ...
                    content ={`<p></p> • Trazabilidad
                            ...
                            <p></p><a href="/santisima_trinidad/documentos_oficiales">Protocolos disponibles aquí </a>`}
                    />
                  </div>
                </div>
                <Titulo id="TituloS" titulo="¿Tienes alguna otra pregunta?"/>
                <Button id="boton-contactoS" className="Button" size="lg" href="/santisima_trinidad/contacto"><IconSubtitle className="fas fa-envelope-open"/>Escribenos</Button>
                <div className="pContacto">Presiona botón para contactarnos por correo o puedes llamarnos directamente al:<p className="pContacto">(+569) 62382642</p></div>
            </div>
          </div>
        </div>
        </div>
