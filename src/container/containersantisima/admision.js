...
import Admision from '../../components/admision/admisionSantisima';
import AdmisionForm from '../../components/admision/admisionformsantisima';
import Imagen from '../../imagenes/banner_admision_santisima.png';
...
function Admisionform() {
    ...
    useEffect(() => {
        fetch('https://escuelasespeciales.cl/tabla_postulacion/list?id_colegio=1')
    ...
    return (
        <>
            ...
            <Titulo  id="TituloS"  icono="fas fa-user-plus" titulo={titulo} Subtitulo2="A continuación se presenta un listado de la documentación requerida para realizar una postulación a nuestra institución, asi como la infomación de los periodos de dicho proceso.-" />
            <Admision  
                    color="SubtituloS1"
